...
try {
    ...
    // 2. 禁用所有按键
    console.log(`[测试] 正在禁用 ${superKeyName}、${appSwitchName}、${altKeyName} 和 F11键...`);
    disableAll();
    ...
    console.log(`✓ ${superKeyName}、${appSwitchName}、${altKeyName} 和 F11键 已被禁用。`);
    ...
    const cleanup = () => {
        ...
        console.log(`\n[测试] 正在恢复 ${superKeyName}、${appSwitchName}、${altKeyName} 和 F11键...`);
        enableAll();
        ...
        console.log(`✓ ${superKeyName}、${appSwitchName}、${altKeyName} 和 F11键 已成功恢复。`);
